...
- Identifier les articles les plus importants pour le PFE
- Créer une base de connaissances exploitable pour le rapport et la soutenance
...
| `notes/`       | Notes personnelles et concepts récurrents |
| `resources/`   | Liens, outils et autres ressources utiles |
